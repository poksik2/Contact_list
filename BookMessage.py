class BookMessage:
    ...
    ENTER_NEW_NAMBER = 'Ведите новый номер контакта: '
    ENTER_NUMBER = 'Ведите номер контакта: '
    #ERR_NUMBER_LEN = f'Длинна номера должна быть {BookList.NUMBER_LEN}'
    EMPTY_NAME = 'Имя не может быть пустым'
    #OVERWRITE_NUMBER = f'Контакт с таким именем уже есть. Хотите изменить номер для {name} (Да - 1, Нет - 2): '
    EXIT = 'ВСЕГО ХОРОШЕГО!!!'
